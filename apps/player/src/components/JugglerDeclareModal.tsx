...
const styles = StyleSheet.create({
  ...
  cancelText: { color: '#908e8a', fontSize: 15, fontWeight: '600' },
  confirmButton: {
    flex: 1,
  ...
  confirmText: { color: '#e0c8f0', fontSize: 15, fontWeight: '700' },
  confirmTextDisabled: { color: '#5c5a58' },
  pickerOverlay: {
    position: 'absolute',
    top: 0,
    left: 0,
  ...
  pickerRowText: { color: '#e0ddd8', fontSize: 14, fontWeight: '600' },
  pickerRowTeam: { color: '#7c7a78', fontSize: 11, textTransform: 'uppercase' },
  pickerClose: {
    marginTop: 8,
    paddingVertical: 10,
    alignItems: 'center',
  ...
  pickerCloseText: { color: '#908e8a', fontSize: 14, fontWeight: '600' },
});
