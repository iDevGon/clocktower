...
export const PHASE_ENTRIES: PhaseEntry[] = [
  ...
  },
  {
    ...
    color: '#8090c0',
    description:
      '밤에는 특정 역할을 가진 플레이어들이 순서대로 깨어나 능력을 사용합니다. 악마는 플레이어를 죽이고, 독살범은 중독시키며, 수도사는 보호합니다. 정보 역할은 스토리텔러로부터 정보를 받습니다.',
  },
  {
    id: 'day',
    name: '낮',
...
export const GAME_RULES: RuleSection[] = [
  ...
  },
  {
    title: '밤 진행',
    content:
      '밤에는 정해진 순서대로 역할이 활성화됩니다. 첫째 밤 순서: 독살범 → 세탁부 → 사서 → 수사관 → 요리사 → 초공감자 → 점쟁이 → 집사 → 첩자. 이후 밤 순서: 독살범 → 수도사 → 탕녀 → 임프 → 까마귀지기 → 장의사 → 초공감자 → 점쟁이 → 집사 → 첩자. 각 역할은 능력을 사용한 후 스토리텔러로부터 피드백을 받습니다.',
  },
  {
    title: '투표와 처형',
    content:
