...
export const PHASE_ENTRIES: PhaseEntry[] = [
  {
    ...
    color: '#908e8a',
    description:
      '플레이어들이 게임에 입장하고 역할이 배정되기를 기다리는 단계입니다. 이야기꾼가 역할을 배정하면 각 플레이어에게 비밀리에 역할이 공개됩니다.',
  },
  {
    id: 'night',
    name: '밤',
    color: '#8090c0',
    description:
      '밤에는 특정 역할을 가진 플레이어들이 순서대로 깨어나 능력을 사용합니다. 악마는 플레이어를 죽이고, 독살범은 중독시키며, 수도사는 보호합니다. 정보 역할은 이야기꾼로부터 정보를 받습니다.',
  },
  {
    id: 'day',
    name: '낮',
...
export const GAME_RULES: RuleSection[] = [
  ...
  },
  {
    title: '밤 진행',
    content:
      '밤에는 정해진 순서대로 역할이 활성화됩니다. 첫째 밤 순서: 독살범 → 세탁부 → 사서 → 수사관 → 요리사 → 초공감자 → 점쟁이 → 집사 → 첩자. 이후 밤 순서: 독살범 → 수도사 → 탕녀 → 임프 → 까마귀지기 → 장의사 → 초공감자 → 점쟁이 → 집사 → 첩자. 각 역할은 능력을 사용한 후 이야기꾼로부터 피드백을 받습니다.',
  },
  {
    title: '투표와 처형',
    content:
...
export const GAME_FLOW: { step: string; description: string }[] = [
  {
    step: '1. 준비',
    description:
      '플레이어들이 게임에 입장합니다. 이야기꾼가 역할을 배분하면 각 플레이어에게 비밀리에 역할이 공개됩니다.',
  },
  {
    step: '2. 첫째 밤',
    description:
